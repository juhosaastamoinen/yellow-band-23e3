...
```
npm create cloudflare@latest -- --template=cloudflare/templates/yellow-band-23e3
```

A live public deployment of this template is available at [https://yellow-band-23e3.templates.workers.dev](https://yellow-band-23e3.templates.workers.dev)
